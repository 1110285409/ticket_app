        ...
        <div class="col-span-3 bg-white p-6 rounded-lg shadow-md">
            ...
            <form action="{{ route('ticket.submit') }}" method="POST" class="mt-6">
                ...
                <div class="mb-4">
                    ...
                    <select id="servicio" name="servicio" class="mt-1 block w-full rounded-md border-gray-300" required onchange="this.form.submit()">
                        <option value="">Seleccione</option>
                        <option value="Acceso carpetas compartidas" {{ old('servicio') == 'Acceso carpetas compartidas' ? 'selected' : '' }}>Acceso carpetas compartidas</option>
                        <!-- Puedes añadir más opciones aquí -->
                    </select>
                </div>
                <div class="mb-4">
                    <label for="capacidad" class="block font-medium text-gray-700">Capacidad solicitada en MB o GB</label>
                    <input type="text" name="capacidad" id="capacidad" class="mt-1 block w-full rounded-md border-gray-300" required>
                </div>
                <div class="mb-4">
                    <label for="centro_costo" class="block font-medium text-gray-700">Centro de costo</label>
                    <input type="text" name="centro_costo" id="centro_costo" class="mt-1 block w-full rounded-md border-gray-300" required>
                </div>
                <div class="mb-4">
                    <label for="autorizador" class="block font-medium text-gray-700">Autorizador centro de costo</label>
                    <input type="text" name="autorizador" id="autorizador" class="mt-1 block w-full rounded-md border-gray-300" required>
                </div>
                <div class="mb-4">
                    <label for="usuario_red" class="block font-medium text-gray-700">Usuario de red a quien se le asigna el permiso</label>
                    <input type="text" name="usuario_red" id="usuario_red" class="mt-1 block w-full rounded-md border-gray-300" required>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="descripcion" id="descripcion" rows="4" class="mt-1 block w-full rounded-md border-gray-300" required></textarea>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('catalogo.index') }}" class="bg-gray-400 text-white py-2 px-4 rounded hover:bg-gray-500">Cancelar</a>
                </div>
            </form>
